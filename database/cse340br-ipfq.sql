...
CREATE TABLE public.vendor (
  vendor_id INT GENERATED BY DEFAULT AS IDENTITY,
  vendor_name CHARACTER VARYING NOT NULL,
  vendor_address CHARACTER VARYING NOT NULL,
...
-- Add vendor to the inventory table
ALTER TABLE public.inventory ADD vendor_id integer;
...
-- Create relationship between 'vendor' and 'inventory' tables
ALTER TABLE IF EXISTS public.inventory
